...
import 'package:pusula/data/models/recent_activity_model.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  late final List<LegalCategoryModel> _categories;
  late final List<RecentActivityModel> _activities;
  late List<LegalEventModel> _repoDeadlines;

  @override
  void initState() {
    super.initState();
    _categories = _repo.getCategories();
    _activities = _repo.getRecentActivities();
    _repoDeadlines = _repo.getUpcomingDeadlines();
  }
  ...
  Widget build(BuildContext context) {
    ...
    final allDeadlines = [..._repoDeadlines, ...workflow.procedureDeadlines];
            ...
            child: IndexedStack(
              ...
              children: [
                AnimatedCrossFade(
                  ...
                  secondChild: _buildHomeContent(allDeadlines),
  ...
  Widget _buildHomeContent(List<LegalEventModel> deadlines) {
              ...
              Expanded(
                child: Column(
                  ...
                  children: const [
                    ...
                    SizedBox(height: 6),
                    Text(
                      'Günlük hayatta sık karşılaşılan haklarınızı keşfedin.',
                      style: TextStyle(
                        fontSize: 13,
                        height: 1.5,
